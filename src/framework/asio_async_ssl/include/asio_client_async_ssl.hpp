#ifndef ASIO_CLIENT_ASYNC_SSL_HPP
#define ASIO_CLIENT_ASYNC_SSL_HPP
...
class session : public std::enable_shared_from_this<session>
{
    public:
        ...
        resolver_(ioc), socket_(ioc, ctx), srv_(srv)
        {
        }
        ...
        void on_resolve(error_code_t ec, results_t results)
        {
            ...
            net::async_connect(socket_.next_layer(), results,
        ...
        {
            error_code_t ec;
            socket_.next_layer().shutdown(net::socket_base::shutdown_both, ec);
